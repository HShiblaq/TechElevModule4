...
//calc the operation and update display
...
operators.forEach(operator)
{
  ...
  let equalElement = document.getElementsByClassName("equal-sign")
  
 equalElement.addEventListener("click",performOperation)
